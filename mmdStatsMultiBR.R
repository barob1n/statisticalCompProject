...
#
# input: the two samples X and Y along with m the number of points in each 
#        sample (assumed to be equal)
#
# Unbiased Quadratic Time Esimator:
#   uMMDDecision(X,Y,m,R) does the tests for given number of boot comparisons R
#   uMMD(X,Y,m) will give you the statistic for the original sample without 
#   giving you a value to compare it to
...
#   lMMDDecision(X,Y,R)  Not a very fast method (just coded in the stuff for 
#   other statistics) 
#
################################################################################
